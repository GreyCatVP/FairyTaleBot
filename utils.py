...
async def generate_fairytale():
    ...
    part1_prompt = messages + [{
        "role": "user",
        "content": "Напиши первую часть сказки (вступление), до 500 символов."
    }]
...
Используй тех же героев и продолжи сюжет.""".format(part1)
        )
    }]
...
Заверши доброй моралью и фразой вроде «Вот и сказке конец».""".format(part1, part2)
        )
    }]
